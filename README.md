<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>Boundary et Vault</title><style>
/* cspell:disable-file */
...
</style></head><body><article id="4ed94c6f-b4d4-4adf-ae56-c59e2bff3b67" class="page sans"><header><h1 class="page-title">Boundary et Vault</h1></header><div class="page-body"><h1 id="ec8a01b3-ca5e-4ffb-a6cd-dd330f532072" class="">Configuration de la base de données AITECH</h1><p id="3a93a432-1529-4f29-970e-0577a995d26e" class="">
</p><pre id="57e799a7-06a5-4c16-b777-cde76378edee" class="code"><code>$ export PG_DB=&quot;aitech&quot;
...
$ psql -d $PG_URL -f aitech-roles.sql --quiet</code></pre><h1 id="7e485577-d982-49f1-a034-969c82ce7414" class="">Configuration du Vault</h1><pre id="84c1db72-655f-4278-9977-140b1eef68d6" class="code"><code>$ export VAULT_ADDR=&quot;http://127.0.0.1:8200&quot;
...
#Créez le rôle DBA qui crée les informations d’identification avec :dba.sql.hcl
...
# exemple tocken : hvs.CAESIHFbEP7V62Pn1m5CkAzXy2_RwgWQLHqbzzQTKweaQNAHGh4KHGh2cy4wSnhWS3FXZzdRSk1NTklhdExoZEx5MXQ</code></pre><h1 id="3e917971-38d0-41ac-b01b-a16ed4f77835" class="">Configuration de Boundary</h1><pre id="7b4ee14c-1cbb-4a5a-86fc-6e044a7ed8b2" class="code"><code>#Démarrage de boundary
$ sudo boundary dev
...
# Test de connection
$ boundary connect postgres -target-id $VIEWER_TARGET_ID -username postgres</code></pre><h1 id="86b9deab-8317-479c-ab59-203ceccd28f4" class=""></h1><pre id="daf030ea-eb15-4ca2-8261-d192295e72e2" class="code"><code># Create vault credential store
...
$ boundary connect postgres -target-id ttcp_lAHumT351N -dbname aitech</code></pre></div></article></body></html>
